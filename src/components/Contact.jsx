  ...
  return (
    <div className="w-full md:px-21 py-20">
        <div className="p-12 flex flex-col md:flex-row w-full space-y-4">
            <form 
                className="flex flex-col justify-center md:justify-start w-full md:w-1/2 space-y-3" 
                action="https://api.web3forms.com/submit" 
                method="POST"
            >
                <header className="text-[#F6BD60] text-2xl md:">Send me a message!</header>
                ...
                className="text-black w-3/4 rounded-lg shadow-lg px-1 py-2 outline-none border-none" 
                required 
                /> 
                <input 
                type="email" 
                ...
                required
                ></textarea>
                <button className="h-[5vh] w-1/3 border-none text-black bg-[#F6BD60] rounded-[50px] cursor-pointer transition-all duration-300 ease-in-out hover:text-[#535353]">
                    Submit
                </button>
            </form>
            <div className="flex flex-col w-full md:w-1/2 space-y-4">
                <div className="flex flex-col text-black border-none rounded-[18px] outline-none space-y-3">
                    <header className="text-[#F6BD60] text-2xl md:text-4xl">Info</header>
                ...
                <div className="flex flex-col text-black border-none rounded-[18px] space-y-3 outline-none">
                    <header className="text-[#F6BD60] text-2xl md:text-4xl">Socials</header>
